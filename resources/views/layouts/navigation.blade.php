<!-- filepath: /c:/laragon/www/Print2Connect/resources/views/layouts/navigation.blade.php -->
<nav x-data="{ open: false }" class="bg-white shadow">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="url('/post_print_requests')" :active="request()->is('post_print_requests')">
                        {{ __('Post') }}
                    </x-nav-link>
    ...
    <div :class="{ 'block': open, 'hidden': ! open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @endif
            <x-responsive-nav-link :href="route('users.show', auth()->user())" :active="request()->routeIs('users.show', auth()->user())">
                {{ __('Profile') }}
            </x-responsive-nav-link>
        </div>
